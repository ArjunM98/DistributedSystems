...
public class LogSetup {
    ...
    private void initialize(Level level) throws IOException {
        ...
        // Minimize zookeeper noise; take max_priority(ERROR, level)
        Logger.getLogger("org.apache.zookeeper").setLevel(level.isGreaterOrEqual(Level.ERROR) ? level : Level.ERROR);
    }
